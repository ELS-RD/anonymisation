...
def test_extend_names():
    ...
    texts1 = [text1]
    offsets1 = [[Offset(12, 17, "PERS"), Offset(36, 43, "PERS")]]
    offset_expected_result = [Offset(4, 17, "PERS"), Offset(28, 43, "PERS")]
    ...
    assert ExtendNames.get_extended_extracted_name_multiple_texts(texts=texts1,
                                                                  offsets=offsets1,
                                                                  type_name="PERS") == [[Offset(4, 17, "PERS"),
                                                                                         Offset(28, 43, "PERS"),
                                                                                         Offset(12, 17, "PERS"),
                                                                                         Offset(36, 43, "PERS")]]
    ...
    texts3 = [text3]
    offsets3 = [[Offset(9, 16, "PERS"), Offset(39, 46, "PERS")]]
    offset_expected_result3 = [Offset(9, 46, "PERS")]
    ...
    texts5 = [text5]
    offsets5 = [[Offset(8, 16, "PERS")]]
    offset_expected_result5 = [Offset(8, 37, "PERS")]
    ...
    texts6 = [text6]
    offsets6 = [[Offset(0, 3, "ORGANIZATION")]]
    offset_expected_result6 = [Offset(0, 23, "ORGANIZATION")]
