...
def test_match_person():
    ...
    assert get_partie_pers(text1) == [Offset(2, 11, "PERS")]
    text2 = "- Toto Popo, né le 30"
    assert get_partie_pers(text2) == [Offset(2, 11, "PERS")]
    text3 = "- Vanessa née le 1er octobre 1987 a TOULON (Var),"
    assert get_partie_pers(text3) == [Offset(2, 9, "PERS")]
    text4 = "•   Eugène né le 23 mars 1997 à Grenoble ( 38"
    assert get_partie_pers(text4) == [Offset(4, 10, "PERS")]
