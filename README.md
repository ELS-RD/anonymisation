...
It doesn't manage pseudo-anonymization (replacing entities text by initials), deiding what to hide, etc.
...
- find all Upcase expressions and check if there is a first name in it
- Court formation // RG number
